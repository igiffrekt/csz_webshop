...
| Server-side price calculation | Fetch prices from Strapi, never trust client-submitted amounts | 2026-01-21 |
| VAT extraction from gross | Hungarian prices include VAT, extract breakdown using 27% rate | 2026-01-21 |
